...
namespace Game.Screens
{
    ...
    abstract class MenuScreen : GameScreen
    {
        ...
        public override void Draw(GameTime gameTime)
        {
            ...
            if (ScreenState == ScreenState.TransitionOn) { position.X -= transitionOffset * 512; }
            else { position.X += transitionOffset * 1024; }
            ...
            Color titleColor = new Color(62, 69, 71, TransitionAlpha);
