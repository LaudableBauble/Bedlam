...
namespace Game.Screens
{
    ...
    class LevelEditorScreen : GameScreen
    {
        ...
        public override void LoadContent()
        {
            ...
            //Initialize the editor and load its content.
            _Editor = new LevelEditor(ScreenManager.Game.Window.ClientBounds);
        ...
        public override void HandleInput(InputState input)
        {
            ...
            //Otherwise let the editor handle input as usual.
            else
            {
