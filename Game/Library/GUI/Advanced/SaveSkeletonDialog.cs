...
namespace Library.GUI
{
    ...
    /// </summary>
    public class SaveSkeletonDialog : Form
    {
        #region Fields
        ...
        public delegate void SkeletonSavedHandler(object obj, SkeletonEventArgs e);
        public event SkeletonSavedHandler SkeletonSaved;
        #endregion
        ...
        /// <summary>
        /// Let the world know that a skeleton has been saved.
        /// </summary>
        /// <param name="fileName">The file name of the saved skeleton.</param>
        protected virtual void SkeletonSavedInvoke(string fileName)
        {
            //If someone has hooked up a delegate to the event, fire it.
            if (SkeletonSaved != null) { SkeletonSaved(this, new SkeletonEventArgs(fileName)); }
        }
        /// <summary>
        ...
        {
            //If a skeleton has been selected for loading, invoke the event.
            if (_Textbox.Text != null) { SkeletonSavedInvoke(_Textbox.Text); }
