...
{
    /// <summary>
    /// Field list items are items used to populate a list with field data.
    /// </summary>
    public class FieldListItem : ListItem
    {
        #region Fields
