...
{
    /// <summary>
    /// An animation is basically a list of keyframes that together lay the key steps of the animation and trust some sort of interpolation to do the fine tuning in between.
    /// </summary>
    public class Animation
    {
        ...
        public delegate void KeyframeAddedHandler(object obj, EventArgs e);
        public delegate void KeyframeRemovedHandler(object obj, EventArgs e);
        public event KeyframeAddedHandler KeyframeAdded;
        public event KeyframeRemovedHandler KeyframeRemoved;
        #endregion
